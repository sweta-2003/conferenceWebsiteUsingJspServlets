    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="registerationServlet"enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="name">Call for paper</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="topic">
                                    <label class="label--desc">topic chosen</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    ...
                                    <label class="label--desc">files</label>
                                </div>
                            </div>
                        </div>
...
if(status=="success"){
	swal("Congrats","You've successfully registered for the RACE'23","success");
}else{
	swal("Sorry","Upload the file to register","error");
}
</script>
